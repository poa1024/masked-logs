...
class MaskerTest {
    ...
    fun testMaskUrl() {
        ...
        val expectedMaskedLOg =
            "https://poa1024.com/order/<MASKED>?apikey=<MASKED>&num=8787&APIKEY=<MASKED>&apikey=<MASKED>"
    ...
    fun testMaskMap() {
        ...
        val expectedMaskedLog =
            "{person_id=<MASKED>, unique_app_id   =   <MASKED>  ,uniqueAppId=<MASKED>,unique-app-id=<MASKED>, p_unique_app_id=<MASKED>), my_surname=Perekhod, mySurname=Perekhod, my-surname=Perekhod, null=null, empty=, number=1234}"
        val maskedLog = fieldMasker.mask(log)
        assertThat(maskedLog).isEqualTo(expectedMaskedLog)
    }
